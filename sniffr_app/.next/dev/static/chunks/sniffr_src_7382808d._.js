...
"[project]/sniffr/src/utils/devtools/consolePatch.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function patchConsoleMethod(obj, method, wrapper) {
    ...
    const patched = function(...args) {
        ...
        try {
            ...
            try {
                originalMethod.call(this, "[DevTools wrapper error]", err instanceof Error ? err.message : err);
            } catch  {
        ...
        try {
            ...
            try {
                originalMethod.call(this, "[DevTools original method error]", err instanceof Error ? err.message : err);
            } catch  {
    ...
    return ()=>{
        ...
        if (isStillPatched) {
            const restored = safeDefineProperty(obj, method, descriptor ?? {
                configurable: true,
                enumerable: true,
                writable: true,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sniffr/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$src$2f$utils$2f$devtools$2f$consolePatch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sniffr/src/utils/devtools/consolePatch.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
function useConsolePatch() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useConsolePatch.useEffect": ()=>{
            ...
            ;
            const disposers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$src$2f$utils$2f$devtools$2f$consolePatch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["patchConsoleMethods"])(console, __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$src$2f$utils$2f$devtools$2f$consolePatch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOG_METHODS"], {
                "useConsolePatch.useEffect.disposers": (method, ...args)=>{
                    const entry = {
                        method,
                        timestamp: Date.now(),
                        payload: args.map({
                            "useConsolePatch.useEffect.disposers": (a)=>a === undefined ? __TURBOPACK__imported__module__$5b$project$5d2f$sniffr$2f$src$2f$utils$2f$devtools$2f$consolePatch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNDEFINED_MARKER"] : a
                        }["useConsolePatch.useEffect.disposers"]),
                        source: ("TURBOPACK compile-time truthy", 1) ? "client" : "TURBOPACK unreachable"
                    };
                // Example forwarding: replace with your DevTools channel (postMessage/WebSocket/etc.)
...
//# sourceMappingURL=sniffr_src_7382808d._.js.map